...
/**
 * Handles playing audio streams received from the server.
 * It manages an audio buffer queue and schedules audio playback to ensure smooth streaming.
 */
export class AudioStreamer {
  ...
  /**
   * Adds a new chunk of PCM16 audio data to the queue.
